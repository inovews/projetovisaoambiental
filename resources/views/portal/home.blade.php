        ...
        <div class="panel-group" id="accordion">
            <div class="panel panel-default">
                ...
                <div id="collapse1" class="panel-collapse collapse in">
                    <ul class="list-group">
                        <li class="list-group-item"><span class="badge">0</span> <a href="">Elvino</a></li>
                        <li class="list-group-item"><span class="badge">0</span> <a href="">Luana</a></li>
                    </ul>
                </div>
            </div>
        </div> 
                    ...
                    <td>
                        <h4>
                            ...
                            <small class="help-block"> Por
                                ...
                                <span class="label label-primary">{!! $curso->name !!}</span> 
                                @endforeach                                    
                            </small>
                            <small class="help-block">
                                Faculdade
                                @foreach ($alunoprof['faculdades'] as $k => $faculdades)
                                <span class="label label-success">{!! $faculdades->name !!}</span> 
                                @endforeach
                            </small>
                            <small class="help-block">
                                Período <span class="label label-default">{!! $alunoprof->periodo !!}
                                </span>
                            </small>
                        </h4>
                    </td>
