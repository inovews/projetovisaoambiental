...
class NoticiasController extends Controller
{
    ...
    {
        return Admin::grid(Noticias::class, function (Grid $grid) {
    ...
    {
        return Admin::form(Noticias::class, function (Form $form) {
...
//                $row->width(3)->display('updated_at', '更新时间');
    ...
    {
        foreach (Noticias::find($request->get('ids')) as $post) {
    ...
    {
        return Noticias::onlyTrashed()->find($request->get('ids'))->each->restore();
    }
}